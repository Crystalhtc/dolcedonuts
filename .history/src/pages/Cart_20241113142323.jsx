        ...
        <div>
            ...
            {[...cart.entries()].map(([product, quantity]) => (
                <div className={styles.itemList} key={product.id}>
                    ...
                    <div className={styles.quantityControls} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <button onClick={() => handleRemove(product)} className={styles.quantity}>-</button>
                        <span>{quantity}</span>
