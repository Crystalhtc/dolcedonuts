            ...
            {submitted ? (
                ...
                <form onSubmit={handleSubmission} className={styles.formContainer}>
                    <div className={styles.nameContainer}>
                        ...
                        <div>
                            <input className={styles.formPlaceholders} type="email" name="email" placeholder="Email"/>
                        </div>

                        <div>
                            <textarea className={styles.formPlaceholders} name="message" placeholder="Your message"></textarea>
                        </div>
                    </div>
