...
export default function Form() {
    ...
    const handleSubmission = async (e) => {
        e.preventDefault();
        console.log('Thank you for your inquiry!', 'You will hear from us within 14 business days');
        setSubmitted(true);
    };
        ...
        <>
            {submitted ? (
                <div className={styles.successfulMessage}>
                    <Image src="/images/check.svg" className={styles.formCheck} width={60} height={60} alt="Success" />
                    <p className={styles.submittedMessage}>Your form has been submitted successfully! We will get back to you shortly.</p>
                    <ButtonSecondary 
                        className={styles.formHomeButton} 
                        title="Go Home" 
