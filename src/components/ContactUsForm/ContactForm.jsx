        ...
        <>
            {submitted ? (
                <div className={styles.successfulMessage}>
                    <h3 className={styles.afterSubmitH3}>Thank you for your inquiry!</h3>
                    <p className={styles.afterSubmitText}>You will hear from us within 14 business days.</p>
                    <SubmitButton buttonText="More Inquiries" onClick={handleMoreInquiries} className={styles.moreInqBtn}/>
                </div>
            ) : (
                <form onSubmit={handleSubmission} className={styles.formContainer}>
                    <div className={styles.nameContainer}>
                        <h3 className={styles.afterSubmitH3}>Get in Touch</h3>
                    ...
                    <SubmitButton buttonText="Submit" className={styles.submitBtn}/>
                </form>
            )}
        </>
    );
